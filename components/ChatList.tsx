...
import type { Chat, MessageType, EmojiStatus } from '@/types';
            ...
            >
              {myChats.map(({ chat, otherUser, lastMsg }) => (
                <ChatListItem
                  ...
                  otherUserStatus={otherUser!.emojiStatus ?? 'none'}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          <p className="font-semibold truncate flex items-center gap-1">{otherUserName}<EmojiStatusIcon status={otherUserStatus} size={14} /></p>
